...
> **성능**: ROC-AUC **0.97** · F1 최적 임계값(T\*=0.75) 적용 시 정밀도 **0.93** / 재현율 **0.81** (F1 0.866)
...
> 위 표는 기본 임계값(0.5) 기준 원본 지표입니다. 실제 운영 임계값(T\*=0.75)을 적용하면 정밀도 0.833→0.932로 개선됩니다 — 상세는 [13. 모델링 실험 기록](#13-모델링-실험-기록) 참고.
